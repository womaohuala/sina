...
@property(nonatomic,copy)NSString *wbId;       //主键id
@property(nonatomic,copy)NSString *text;       //微博内容
@property(nonatomic,copy)NSString *source;     //微博来源
@property(nonatomic,retain)NSNumber *favorited;//是否已经收藏
@property(nonatomic,copy)NSString *thumbnailImage;//缩略图片地址
@property(nonatomic,copy)NSString *bmiddleImage;  //中等尺寸图片地址
@property(nonatomic,copy)NSString *originalImage; //原始图片地址
@property(nonatomic,retain)NSDictionary *geo;     //地理信息字段
@property(nonatomic,retain)WeiboModel *retweetedWB;//被转发的原微博信息字段
@property(nonatomic,retain)WeiboBaseUser *baseUser; //微博作者的用户信息字段
@property(nonatomic,retain)NSNumber *repostCount;   //转发数
